    ...
    <View style={styles.root}>
      ...
      <View style={[styles.header, { paddingTop: insets.top + 8 }]}>
        <View style={styles.headerRow}>
          ...
          <View>
            <Text style={styles.headerSub}>Zëri i Rinisë</Text>
      ...
      >
        ...
        <View style={styles.introPad}>
          <Text style={styles.introTitle}>Këshilli Vendor i Rinisë</Text>
          <Text style={styles.introDesc}>
            KVR është një organ këshillimor pranë Kryetarit të Bashkisë dhe përfaqëson zërin e të rinjve në nivel lokal.
          </Text>
            ...
            >
              ...
              <View style={styles.videoMeta}>
                <View style={styles.videoDuration}>
                  <Text style={styles.videoDurationText}>0:56</Text>
                </View>
                <Text style={styles.videoLabel}>KVR SHKODËR</Text>
              </View>
            </ImageBackground>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.sectionMb}>
          <View style={styles.sectionPadH}>
            <Text style={styles.sectionTitle}>Grupet Tematike</Text>
            <Text style={styles.sectionSubtitle}>KVR Shkodër është organizuar në 4 grupe kryesore.</Text>
          </View>
          ...
          >
            {KVR_GROUPS.map(group => (
              <TouchableOpacity
                key={group.id}
                style={styles.groupCard}
                onPress={() => onList(group.name, group.id)}
                activeOpacity={0.88}
              >
                <View style={[styles.groupIconWrap, { backgroundColor: group.bg, borderColor: group.border }]}>
                  <GroupIcon name={group.iconName} color={group.color} />
                </View>
                <Text style={styles.groupName}>{group.name}</Text>
                <Text style={styles.groupDesc} numberOfLines={3}>{group.desc}</Text>
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
        ...
        <View style={styles.sectionMb}>
          <View style={[styles.sectionHeader, styles.sectionPadH]}>
            <View>
              ...
              <Text style={styles.sectionSubtitle}>Ndiqni iniciativat dhe takimet më të fundit.</Text>
            </View>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  headerSub: {
    ...
    color: RED, textTransform: 'uppercase', letterSpacing: 0.8, marginBottom: 2,
  },
  headerTitle: {
    fontFamily: Typography.fontExtraBold, fontSize: Typography.xxl, color: NAVY,
  },
  iconBtn: {
  ...
  introPad: {
    backgroundColor: Colors.white,
    paddingHorizontal: Spacing.xxl, paddingTop: Spacing.xxl, paddingBottom: Spacing.xxl,
  ...
  introTitle: {
    ...
    color: NAVY, marginBottom: 8, lineHeight: 28,
  },
  introDesc: {
    fontFamily: Typography.fontMedium, fontSize: Typography.base,
    color: Colors.textSecondary, lineHeight: 20, marginBottom: Spacing.xl,
  },
  ...
  playBtn: {
    ...
    justifyContent: 'center', alignItems: 'center',
    shadowColor: '#e30613', shadowOpacity: 0.4, shadowRadius: 12,
  ...
  videoLabel: {
    fontFamily: Typography.fontExtraBold, fontSize: 18, color: '#fff',
  ...
  seeAllBtn: {
    backgroundColor: '#e0f2fe', paddingHorizontal: 12, paddingVertical: 7, borderRadius: Radius.full,
  },
  ...
  // Group cards
  groupCard: {
    width: 210, backgroundColor: Colors.white, borderRadius: Radius.xxl,
  ...
  groupName: {
    ...
    color: NAVY, marginBottom: 6, lineHeight: 20,
  },
  groupDesc: {
    fontFamily: Typography.fontMedium, fontSize: Typography.sm,
  ...
  // Activity cards
  actCard: {
    width: 252, backgroundColor: Colors.white, borderRadius: Radius.xxl,
  ...
  actTitle: {
    ...
    color: NAVY, lineHeight: 21, marginBottom: 6,
  },
  actDesc: {
    fontFamily: Typography.fontMedium, fontSize: Typography.sm,
